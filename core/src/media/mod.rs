...
//! their own CDN URL, OCR runs in-process, and Qwen3-ASR audio transcription
...
pub use self::asr::{
    asr_model_status, install_asr_model, local_asr_available, transcribe_local_file,
    AsrInstallProgress, AsrModelStatus,
};
