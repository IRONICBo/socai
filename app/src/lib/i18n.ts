...
const messages = {
  ...
  "voice.start": { en: "start cloud voice input", zh: "开始云端语音输入" },
  ...
  "voice.unavailable.login": {
    en: "sign in and activate a paid subscription to use cloud voice input. Audio tasks currently use local Whisper small; microphone input is not available for the local route yet.",
    zh: "登录并开通付费服务后可使用云端语音输入。当前音频任务使用本地 Whisper small，本地路由暂未开放麦克风输入。",
  },
  "voice.unavailable.subscription": {
    en: "this account has no active paid subscription. Audio tasks use local Whisper small; microphone input is not available for the local route yet.",
    zh: "当前账号未开通有效付费服务，音频任务使用本地 Whisper small，本地路由暂未开放麦克风输入。",
  },
  "voice.unavailable.credits": {
    en: "this account has no remaining credits. Audio tasks use local Whisper small; microphone input is not available for the local route yet.",
    zh: "当前账号 credits 已用完，音频任务使用本地 Whisper small，本地路由暂未开放麦克风输入。",
  },
  "voice.unavailable.billing": {
    en: "cloud ASR access could not be verified. Audio tasks fall back to local Whisper small; microphone input is temporarily unavailable.",
    zh: "暂时无法确认云端 ASR 付费状态，音频任务将回退到本地 Whisper small，麦克风输入暂不可用。",
  },
  "voice.unavailable.localOnly": {
    en: "audio tasks use local Whisper small; microphone input is not available for the local route yet.",
    zh: "音频任务使用本地 Whisper small，本地路由暂未开放麦克风输入。",
  },
