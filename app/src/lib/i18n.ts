...
const messages = {
  ...
  "settings.asr": { en: "local video transcription", zh: "本地视频转写" },
  "settings.asrReady": { en: "ready", zh: "已就绪" },
  "settings.asrInstall": { en: "install model", zh: "安装模型" },
  "settings.asrInstalling": { en: "installing…", zh: "安装中…" },
  "settings.asrPreparing": { en: "preparing download…", zh: "正在准备下载…" },
  "settings.asrDownloading": {
    en: "downloading model… {percent}%",
    zh: "正在下载模型… {percent}%",
  },
  "settings.asrExtracting": { en: "extracting model…", zh: "正在解压模型…" },
  "settings.asrFinalizing": { en: "installing voice detection…", zh: "正在安装语音检测模型…" },
  "settings.asrHint": {
    en: "Qwen3-ASR runs on this device. The download is about 0.88 GB and audio is never sent to an ASR service.",
    zh: "Qwen3-ASR 在本机运行，下载约 0.88 GB，音频不会发送到在线转写服务。",
  },
  "settings.asrHelperMissing": {
    en: "reinstall app",
    zh: "请重新安装应用",
  },
  "settings.asrInstallFailed": {
    en: "model installation failed. check the network and try again.",
    zh: "模型安装失败，请检查网络后重试。",
  },
